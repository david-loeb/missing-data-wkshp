---
title: "Missing Data Handling for Policy Research & RCTs"
...
## Types of missingness {.smaller .scrollable chalkboard-buttons="true"}
...
Check out [this tool](https://davidloeb-missing-data-app.share.connect.posit.cloud/) for more RCT scenarios
...
## Partial data helps accuracy {chalkboard-buttons="true"}
...
- For help thinking through approaches in RCTs, check out [this tool](https://davidloeb-missing-data-app.share.connect.posit.cloud/)
